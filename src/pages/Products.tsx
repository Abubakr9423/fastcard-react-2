...
const Products = () => {
  ...
  // Initialize wishlist IDs from localStorage
  useEffect(() => {
    const data = JSON.parse(localStorage.getItem('wishlist') || '[]');
    setWishlistIds(data.map((item: any) => item.id));
  }, []);
      ...
      <div className="flex flex-col gap-6 md:w-[300px]">
        <div className="px-3 max-w-337.5 m-auto">
          <div className="flex md:flex-row flex-col gap-8 justify-between py-3">
            ...
            <div>
              <div className="grid md:grid-cols-4 grid-cols-1 xl:grid-cols-4 gap-6 justify-items-center mx-auto w-full">
                        ...
                        {e.hasDiscount ? (
                          <div className="flex gap-3 items-end">
                            ...
                            <div>
                              ...
                              <NumberTicker
                                value={Number(e?.discountPrice) || 0}
